...
public class ShortestJobFirstScheduler extends SchedulerSimulator {
    ...
    public void schedule(List<Process> processes, int contextSwitchTime) {
        ...
        PriorityQueue<Process> readyProcesses = new PriorityQueue<>(Comparator.comparingInt(p -> p.burstTime));
        ...
        while (true) {
            ...
            System.out.printf("Time %d: Process %s with burst time %d is executing\n", currentTime, selected.name, selected.burstTime);
